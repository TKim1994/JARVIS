...
main()
{
	...
	else
	{
		If InStr(aux, "*")
		{
			new_aux := StrReplace(aux, "*", "")
			ProcessKillAllRelated(new_aux)
		}
		else
		{
			CurrentUserProcessKiller(aux)
		}
	}
	ExitApp
}
...
CurrentUserProcessKiller(process_name)
{
	...
	for process in ComObjGet("winmgmts:\\.\root\cimv2").ExecQuery("Select * from Win32_Process")
	{
		...
		{
			;msgbox %temp_pid%
			;msgbox %process_name_current_M% y %process_name_M% o %needle_1_M%
			;msgbox %current_user%
...
;[11]=============================================================================================================================================================================================
ProcessKillAllRelated(process_name)
{
	;Solo elimina los procesos que creo el usuario actual
	INIKILLER3: ;<--------------
	Sleep 1000
